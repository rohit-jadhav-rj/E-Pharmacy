...
<div class="products-container ">
  <div class="product-header row">
    <h5 class="pimg col-lg-1"></h5>
    <h5 class="product-title col-lg-4" style="text-align:left; padding-left:15px;">PRODUCT</h5>
    <h5 class="price col-lg-1" style="text-align:left; padding-left:25px;">PRICE</h5>
    <h5 class="quantity col-lg-2" style="text-align:left; padding-left:20px;">QUANTITY</h5>
    <h5 class="total col-lg-1" style="text-align:left; padding-left:35px;">TOTAL</h5>
    <h5 class="remove col-lg-2"></h5>
  </div>
</div>
...
foreach($_SESSION as $products)
{
  ...
  foreach ($products as $key => $value) {
        ...
        // echo "<img class='dpro1' src='./images/${item.tag}.jpg'>";
                  ...
                  echo "<div class='pimg col-lg-1'>";
                  echo "<img  style='width:50%;' src='./images/$products[4]'>";
                  echo "</div>";
                  echo "<div class='product-title col-lg-4'>";
                  ...
                  echo "</div>"; 
                   ...
                   echo "<div class='price col-lg-1'>".$value."</div>";
                   echo "<input type='hidden' name='price$key' value=".$value."></input>";
                   $p=$value;
                 }else if($key==2){
                   $str = $products[0];
                   // echo "$str";
                   echo "<div class='quantity col-lg-2'>" ; 
...
echo "<div class='basketTotalContainer'>";
            ...
            echo  "</div>";
?>
<div style="position:absolute; right:30.5%;">
